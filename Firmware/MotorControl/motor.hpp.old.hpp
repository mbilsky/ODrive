...
public:
    ...
    struct Config_t {
        ...
        float current_lim_tolerance = 4.0f;  // multiple of current_lim
...
//private:
    ...
    float thermal_current_lim_ = 20.0f;  //[A]
    ...
    auto make_protocol_definitions() {
        return make_protocol_member_list(
            ...
            make_protocol_ro_property("error_register", &error_register),
            make_protocol_ro_property("error_register2", &error_register2),
            ...
            make_protocol_function("get_drv_error", *this, &Motor::get_drv_error),
